...
public class RingProgressIndicatorSkin implements Skin<RingProgressIndicator> {
    ...
    public RingProgressIndicatorSkin(final RingProgressIndicator indicator) {
        ...
        initFillerArc();
        container.widthProperty().addListener((o, oldVal, newVal) -> fillerArc.setCenterX(newVal.intValue() / 2.0));
        container.heightProperty().addListener((o, oldVal, newVal) -> fillerArc.setCenterY(newVal.intValue() / 2.0));
