...
2. It was primarily developed and fully-tested on Ubuntu\Linux for Ubuntu\Linux.
3. Project doesn't contain unit tests for test purposes. That's why they're disabled for `gradle build` task.
4. Only smoke testing have been performed on Windows.
